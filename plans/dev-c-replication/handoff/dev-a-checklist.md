# Dev C → Dev A — the open work list

**From:** Dev C (replication) · **Date:** 2026-08-16 · **Round:** 8
**Human-readable Vietnamese version:** [`dev-a-gate-board.html`](dev-a-gate-board.html)
...
| S6, S7 | 2026-08-15 | [`2026-08-15-dev-a-s4-s7-and-s5-blocker.md`](../reports/2026-08-15-dev-a-s4-s7-and-s5-blocker.md) |
...
**Reply with:** the release tag and the pushed image digest. Dev D needs the digest for
...
Dev D added this file in #77. It lives in your `Assets/` tree but exists to serve the image
...
This was optional while the master server did not exist. Dev D is deploying it now
...
**Reply with:** done, or "after Dev D confirms the master is reachable".
