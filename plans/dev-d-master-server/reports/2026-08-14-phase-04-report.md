...
| 3 | `docs/operations.md` written, followed by someone else | **Partial** | Written in phase 03 and complete; **nobody other than Dev D has followed it**, because it needs a VPS |
...
| `docs/infrastructure-handover.md` | Week 14 | Complete | Dev B (the master server's backup) |
...
| Somebody other than Dev D rehearsing a deploy | follows the VPS | `docs/infrastructure-handover.md` § 5 |
...
There is no phase 05. What remains for Dev D is bounded and listed here so nobody has to
reconstruct it:
