...
| **CMB-05** | ☐ | **Hitbox server là hình nộm đứng nhân tạo cao 1,8 m** với bảng hệ số cứng `Head 4.0 / Body 1.0 / Limb 0.75`, đối chiếu bảng author của prefab `head 3.0 / body 1.3 / 0.9-1.0`. Thân thể đang cúi nằm trọn trong hộp **chân**, nên headshot lên người đang cúi tính là `Limb` × 0,75 | `NetServerActor.cs:788-808`; `ServerFireResolver.cs:77-83` | 1 | |
