...
**Closes** the client track's phase-00 task 1 (*read and understand the codebase*). That spec was deleted 2026-08-26 with the rest of the track — `git show 68acdd9:plans/unity-client/README.md` records why and how to recover it.
...
2. **There is a 38th gameplay `Input.*` read outside `Assembly-CSharp/`.**
   ...
   [code-conventions.md § 7](code-conventions.md), so it is named here rather than changed.
...
Phase-00 criterion 6 (spec deleted 2026-08-26)
...
- `plans/unity-client/phases/phase-00-foundation.md` — the task this closes; deleted, `git show 68acdd9:plans/unity-client/README.md`
