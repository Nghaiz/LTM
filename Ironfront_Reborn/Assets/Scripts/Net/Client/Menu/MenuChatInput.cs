...
namespace Ironfront.Net.Unity.Client.Menu
{
    ...
    public sealed class MenuChatInput : MonoBehaviour
    {
        ...
        public void Configure(InputField field, Action<string> submit,
            Func<bool>? submitKeyDown = null, EventSystem? eventSystem = null)
        {
            Unsubscribe();
            _field = field;
            _submit = submit;
        ...
        {
            if (_submitKeyDown?.Invoke() == true) Submit(value);
        }
        ...
        private void RestoreFocus()
        {
            ...
            if (eventSystem != null) eventSystem.SetSelectedGameObject(_field.gameObject);
        }
