...
namespace InternalRealtimeCSG
{
	public struct MeshInstanceKey
	{
		...
		public static MeshInstanceKey GenerateKey(SurfaceFlags surfaceFlags, Material renderMaterial, PhysicsMaterial physicsMaterial)
		{
			...
			PhysicsMaterial physicMaterial = physicsMaterial;
